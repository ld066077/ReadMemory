...
stable wrappers into ~/.local/bin.
EOF
}
...
write_wrapper "readmemory-uninstall" "$READMEMORY_INSTALL_ROOT/uninstall.sh"

echo "ReadMemory installed."
echo "Version: $APP_VERSION"
echo "Install root: $INSTALL_ROOT"
echo "Commands: $BIN_DIR/readmemory, $BIN_DIR/readmemory-mcp"
