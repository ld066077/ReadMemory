...
- Synthetic EPUB generated by `tests/helpers.py`.

If a phase cannot be verified against this generated fixture, the phase is not closed.
...
The MVP is not finished until this loop works with the generated fixture EPUB:
