...
- Fixture EPUB import using the synthetic EPUB generated by `tests/helpers.py`.
...
2. `readmemory doctor`
3. Import a generated fixture EPUB or another local EPUB you are allowed to use.
